...
!     left lead
      aright=alambda(1,2)
      ae=0.25*beta*(alin+u(1)-uin+dgin)**2 / alin
      be=0.25*beta*(alin-u(1)+uin-dgin)**2 / alin
...
!       contributions
      ...
      ce=0.25*beta*(alout+uout-u(n)+dgout)**2 / alout
      de=0.25*beta*(alout-uout+u(n)-dgout)**2 / alout
